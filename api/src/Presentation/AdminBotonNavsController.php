...
use App\Application\Admin\BotonNav\CreateBotonNavUseCase;
use App\Application\Admin\BotonNav\UpdateBotonNavUseCase;
use App\Application\Admin\BotonNav\DeleteBotonNavUseCase;
use App\Domain\Interfaces\BotonNavRepositoryInterface;
use Exception;

class AdminBotonNavsController
{
    ...
    public function __construct(
        CreateBotonNavUseCase $createUseCase,
        UpdateBotonNavUseCase $updateUseCase,
        DeleteBotonNavUseCase $deleteUseCase,
        BotonNavRepositoryInterface $repository
    ) {
