...
use App\Application\Admin\Galeria\CreateGaleriaUseCase;
use App\Application\Admin\Galeria\UpdateGaleriaUseCase;
use App\Application\Admin\Galeria\DeleteGaleriaUseCase;
use App\Domain\Interfaces\GaleriaRepositoryInterface;
use Exception;

class AdminGaleriasController
{
    ...
    public function __construct(
        CreateGaleriaUseCase $createUseCase,
        UpdateGaleriaUseCase $updateUseCase,
        DeleteGaleriaUseCase $deleteUseCase,
        GaleriaRepositoryInterface $repository
    ) {
