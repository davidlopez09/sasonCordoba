...
use App\Application\Admin\Caracteristica\CreateCaracteristicaUseCase;
use App\Application\Admin\Caracteristica\UpdateCaracteristicaUseCase;
use App\Application\Admin\Caracteristica\DeleteCaracteristicaUseCase;
use App\Domain\Interfaces\CaracteristicaRepositoryInterface;
use Exception;

class AdminCaracteristicasController
{
    ...
    public function __construct(
        CreateCaracteristicaUseCase $createUseCase,
        UpdateCaracteristicaUseCase $updateUseCase,
        DeleteCaracteristicaUseCase $deleteUseCase,
        CaracteristicaRepositoryInterface $repository
    ) {
