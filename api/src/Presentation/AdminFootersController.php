...
use App\Application\Admin\Footer\CreateFooterUseCase;
use App\Application\Admin\Footer\UpdateFooterUseCase;
use App\Application\Admin\Footer\DeleteFooterUseCase;
use App\Domain\Interfaces\FooterRepositoryInterface;
use Exception;

class AdminFootersController
{
    ...
    public function __construct(
        CreateFooterUseCase $createUseCase,
        UpdateFooterUseCase $updateUseCase,
        DeleteFooterUseCase $deleteUseCase,
