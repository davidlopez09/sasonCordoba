...
use App\Application\Admin\Platillo\CreatePlatilloUseCase;
use App\Application\Admin\Platillo\UpdatePlatilloUseCase;
use App\Application\Admin\Platillo\DeletePlatilloUseCase;
use App\Domain\Interfaces\PlatilloRepositoryInterface;
use Exception;

class AdminPlatillosController
{
    ...
    public function __construct(
        CreatePlatilloUseCase $createUseCase,
        UpdatePlatilloUseCase $updateUseCase,
        DeletePlatilloUseCase $deleteUseCase,
        PlatilloRepositoryInterface $repository
    ) {
