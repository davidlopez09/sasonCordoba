...
use App\Application\Admin\MenuNav\CreateMenuNavUseCase;
use App\Application\Admin\MenuNav\UpdateMenuNavUseCase;
use App\Application\Admin\MenuNav\DeleteMenuNavUseCase;
use App\Domain\Interfaces\MenuNavRepositoryInterface;
use Exception;

class AdminMenuNavsController
{
    ...
    public function __construct(
        CreateMenuNavUseCase $createUseCase,
        UpdateMenuNavUseCase $updateUseCase,
        DeleteMenuNavUseCase $deleteUseCase,
        MenuNavRepositoryInterface $repository
    ) {
