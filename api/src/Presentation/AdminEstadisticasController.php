...
use App\Application\Admin\Estadistica\CreateEstadisticaUseCase;
use App\Application\Admin\Estadistica\UpdateEstadisticaUseCase;
use App\Application\Admin\Estadistica\DeleteEstadisticaUseCase;
...
class AdminEstadisticasController
{
    ...
    public function __construct(
        CreateEstadisticaUseCase $createUseCase,
        UpdateEstadisticaUseCase $updateUseCase,
        DeleteEstadisticaUseCase $deleteUseCase,
        EstadisticaRepositoryInterface $repository
    ) {
