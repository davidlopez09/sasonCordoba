...
use App\Application\Admin\BotonParticipa\CreateBotonParticipaUseCase;
use App\Application\Admin\BotonParticipa\UpdateBotonParticipaUseCase;
use App\Application\Admin\BotonParticipa\DeleteBotonParticipaUseCase;
use App\Domain\Interfaces\BotonParticipaRepositoryInterface;
use Exception;

class AdminBotonParticipasController
{
    ...
    public function __construct(
        CreateBotonParticipaUseCase $createUseCase,
        UpdateBotonParticipaUseCase $updateUseCase,
        DeleteBotonParticipaUseCase $deleteUseCase,
        BotonParticipaRepositoryInterface $repository
    ) {
